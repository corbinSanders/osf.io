...
@must_be_logged_in
@ember_flag_is_active(flags['EMBER_USER_PROFILE'])
...
@must_be_logged_in
@ember_flag_is_active(flags['EMBER_USER_SETTINGS'])
...
@must_be_logged_in
@ember_flag_is_active(flags['EMBER_USER_SETTINGS_ACCOUNTS'])
...
@must_be_logged_in
@ember_flag_is_active(flags['EMBER_USER_SETTINGS_ADDONS'])
...
@must_be_logged_in
@ember_flag_is_active(flags['EMBER_USER_SETTINGS_NOTIFICATIONS'])
...
@must_be_logged_in
@ember_flag_is_active(flags['EMBER_USER_SETTINGS_APPS'])
...
@must_be_logged_in
@ember_flag_is_active(flags['EMBER_USER_SETTINGS_TOKENS'])
